...
class ACEVisualizer:
    ...
    def _render_frame_from_buffers(self):
        ...
        trajectory_mesh, frustum_images, trajectory_est_mesh = self.trajectory_buffer.get_mesh()
        ...
        cams_est_RGBA = self._render_trajectory(r, trajectory_est_mesh, camera, smooth_camera_pose, [])
        blended_RGB = self._blend_images(blended_RGB, cams_est_RGBA)
    ...
    def render_reloc_frame(self, query_pose, query_file, est_pose, est_error, sparse_query):
        ...
        self.trajectory_buffer.grow_camera_path(query_pose, est_pose)
